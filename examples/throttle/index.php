...
$(function(){
  ...
  var resize_counter_1 = 0,
      resize_counter_2 = 0;
  
  // This function is not throttled, but instead bound directly to the event.
  function resize_1() {
    var html = 'resize handler executed: ' + resize_counter_1++ + ' times'
  ...
  function resize_2() {
    var html = 'throttled resize handler executed: ' + resize_counter_2++ + ' times'
      + '<br/>window dimensions: ' + $(window).width() + 'x' + $(window).height();
...
$(function(){
  ...
  var scroll_counter_1 = 0,
      scroll_counter_2 = 0;
  
  // This function is not throttled, but instead bound directly to the event.
  function scroll_1() {
    var html = 'scroll handler executed: ' + scroll_counter_1++ + ' times'
  ...
  // throttled function can be passed to .unbind to unbind the function.
  function scroll_2() {
    var html = 'throttled scroll handler executed: ' + scroll_counter_2++ + ' times'
      + '<br/>window scrollLeft: ' + $(window).scrollLeft() + ', scrollTop: ' + $(window).scrollTop();
